...
class FileTest extends TestCase
{
    ...
    public function it_uploads_a_file_in_root_directory()
    {
        ...
        $localFile = env('BASE_PATH') . 'tests/stubs/files/' . $this->testFile;
        ...
        $this->assertTrue(\App\Filesystem\File::uploadFile($uploadedFile, $this->testFile, $this->testDisk));
    ...
    public function it_uploads_a_file_in_a_given_directory()
    {
        ...
        $this->assertTrue(\App\Filesystem\File::uploadFile($uploadedFile, $this->testFile, $this->testDisk, '/' . $this->testDirectory));
    ...
    public function it_generates_a_unique_name_for_a_file()
    {
        ...
        $localFile = env('BASE_PATH') . 'tests/stubs/files/file_to_upload.jpg';
        ...
        $fileName = \App\Filesystem\File::generateUniqueFileName($uploadedFile);
    ...
    public function it_returns_only_the_files_present_in_root_directory()
    {
        ...
        $result = \App\Filesystem\File::filesIn($this->testDisk);
    ...
    public function it_returns_size_of_a_given_file()
    {
        ...
        $size = \App\Filesystem\File::size('/my-cat.jpg', $this->testDisk);
    ...
    public function it_returns_last_modified_date_of_requested_file()
    {
        ...
        $date = \App\Filesystem\File::lastModified('/my-cat.jpg', $this->testDisk);
    ...
    public function it_returns_array_of_all_files_matching_a_given_word_in_a_given_disk()
    {
        ...
        $result = \App\Filesystem\File::searchDisk('cute', $this->testDisk);
